...
xcrun swiftc "$@" -target arm64-apple-macos13.0 -import-objc-header Bridging.h main.swift Storage.swift Dashboard.swift -o "$APP/Contents/MacOS/MiniStats" -framework AppKit -framework IOKit -framework ServiceManagement -framework UserNotifications
